...
@click.option("--aws-vpc-id", default=None, help="Override VPC id for managed networking checks.", hidden=True)
@click.option("--aws-subnet-ids", default=None, help="Override subnet ids for managed networking checks.", hidden=True)
